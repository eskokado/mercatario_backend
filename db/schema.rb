...
ActiveRecord::Schema[8.0].define(version: 2025_05_15_191919) do
  ...
  create_table "certidoes", force: :cascade do |t|
    t.integer "credor_id"
    t.string "tipo"
    t.string "origem"
    t.string "status"
  ...
  create_table "documentos_pessoais", force: :cascade do |t|
    t.integer "credor_id"
    t.string "tipo"
    t.string "arquivo_url"
  ...
  add_foreign_key "certidoes", "credores"
  add_foreign_key "documentos_pessoais", "credores"
  add_foreign_key "precatorios", "credores"
end
